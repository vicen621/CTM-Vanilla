...
public class CTMVanillaCommand extends BaseCommand {
    ...
    public static class TimerCommand extends BaseCommand {
    ...
    @CommandAlias("playing")
    @CommandPermission("ctm.op")
    @Description("Manipulates the player's list")
    public static class PlayingComand extends BaseCommand {
        ...
        public void onAdd(CommandSender sender, OnlinePlayer op) {
        ...
        public void onRemove(CommandSender sender, OnlinePlayer op) {
            Player p = op.getPlayer();
